        ...
        if cache_enabled:
            try:  # remove mods from decompiled_mods which not in current mods_list
                for mod in os.listdir(os.path.join('result', 'decompiled_mods')):
                    path_to_mod = os.path.join('result', 'decompiled_mods', mod)
            ...
            #     for mod in os.listdir(os.path.join('result', 'deobfuscated_mods')):
            #         mod_name = mod.removesuffix('.jar').removesuffix('_mapped_official') + '.jar'
            #         if mod_name in use_cached:
            #             os.remove(os.path.join(os.path.join('result', 'deobfuscated_mods', mod)))
            ...
            try:  # remove mods from deobfuscated_mods which not in current mods_list
                for mod in os.listdir(os.path.join('result', 'deobfuscated_mods')):
                    ...
                    if mod_name in mods_list_without_space:
                        ...
                        os.remove(os.path.join('result', 'deobfuscated_mods', mod))
